...
public partial class SocialNetworkDbContext : DbContext
{
    ...
    public virtual DbSet<UserRequestGroup> UserRequestGroups { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Post>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Posts)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__posts__user_id__7908F585");
        ...
        modelBuilder.Entity<UserRequestGroup>(entity =>
        {
            entity.HasKey(e => new { e.UserId, e.GroupId }).HasName("PK__user_req__A4E94E55F1F0CD2E");

            entity.ToTable("user_request_group");
            ...
            entity.HasOne(d => d.Group).WithMany(p => p.UserRequestGroups)
                .HasForeignKey(d => d.GroupId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_requ__group__12C8C788");

            entity.HasOne(d => d.User).WithMany(p => p.UserRequestGroups)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__user_requ__user___11D4A34F");
        });
